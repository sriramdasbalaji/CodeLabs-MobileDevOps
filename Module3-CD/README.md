...
1. Now, install the latest App Manually. To do this, in the emulator, open up HockeyApp. Click the refresh button and click on the **Patients** app. You will see two versions listed: the current one and the new build. 
    
    > **Note**: Later you will update the app to enable updates from within the app without having to uninstall it first.
    
1. You will have to uninstall the app manually before installing it from HockeyApp. Click the home button and then click the apps button. Click on **Settings** and then click **Apps**. Click on the **Patients** app and click **Uninstall**.
